...
use App\Filament\Resources\EquipmentOldResource\Pages;
use App\Filament\Resources\EquipmentOldResource\RelationManagers;
use App\Models\EquipmentOld;
use Filament\Forms;
...
class EquipmentOldResource extends Resource
{
    protected static ?string $model = EquipmentOld::class;
    
    protected static ?string $navigationGroup = 'Settings';

    protected static ?string $navigationIcon = 'heroicon-o-cube-transparent';

    protected static ?string $navigationLabel = 'Old Equipment';
    ...
    {
        return [
            'index' => Pages\ListEquipmentOlds::route('/'),
            'create' => Pages\CreateEquipmentOld::route('/create'),
            'edit' => Pages\EditEquipmentOld::route('/{record}/edit'),
        ];
    }
}
