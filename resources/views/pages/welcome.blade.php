        ...
        <div class="mx-auto max-w-7xl py-32 sm:py-48 lg:py-46">
          <div class="hidden sm:mb-8 sm:flex sm:justify-center">
            <div class="relative rounded-full px-2 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              This is PMSi Internal Website only and is not available online. <a href="https://www.pmsi-cal.com" target="_blank" rel="noopener noreferrer" class="font-semibold text-indigo-600"><span class="absolute inset-0" aria-hidden="true"></span>Go to Official Website <span aria-hidden="true">&rarr;</span></a>
            </div>
          </div>
          <div class="text-center">
            <h1 class="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">Precision Measurement Specialists, inc.</h1>
            <p class="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">A 'metrology' company since 1998</p>
            <div class="mt-6 flex items-center justify-center gap-x-6">
              <a href="/admin" class="rounded-full bg-emerald-600 px-6 py-3 text-sm font-semibold text-white shadow-md hover:bg-emerald-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500">Administration</a>
