        ...
        <div class="mx-auto max-w-7xl py-32 sm:py-48 lg:py-46">
          ...
          <div class="text-center">
            ...
            <div class="mt-6 flex items-center justify-center gap-x-6">
              <a href="/admin" class="rounded-full bg-emerald-600 px-6 py-3 text-sm font-semibold text-white shadow-md hover:bg-emerald-500 hover:text-gray-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500">ADMINISTRATION</a>
