...
<div id="tutorial-modal" class="fixed inset-0 z-50 hidden">
  ...
  <div id="modal-content-wrapper" class="relative w-full h-full flex items-center justify-center">
    ...
    <div id="tutorial-container" class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-4 w-11/12 md:w-1/4 transition-all duration-300 animate-fadeInScale relative border border-transparent hover:border-emerald-300">
      ...
      <div class="flex items-center justify-between mb-3">
        ...
        <div class="w-24 flex justify-start">
          <button id="tutorial-close" class="px-3 py-1 bg-emerald-600 text-white rounded-sm hover:bg-emerald-700 transition-colors">
            Close
          </button>
        </div>
        ...
        <div class="flex items-center justify-center flex-grow">
          <img src="/images/default avatar.png" alt="Cat Narrator" class="w-12 h-12 rounded-full border border-emerald-300 mr-2">
        ...
        <div class="w-24 flex justify-end">
          <div class="flex space-x-2">
            <button id="tutorial-prev" class="px-3 py-1 bg-emerald-200 text-emerald-800 rounded-sm hover:bg-emerald-300 transition-colors hidden">
              Prev
            </button>
            <!-- Prevent text wrap for button -->
            <button id="tutorial-next" class="px-3 py-1 bg-emerald-600 text-white rounded-sm hover:bg-emerald-700 transition-colors whitespace-nowrap">
              Next
            </button>
          </div>
        </div>
      ...
      <div id="tutorial-arrow" class="hidden absolute w-0 h-0 border-t-6 border-b-6 border-l-6 border-transparent" style="border-left-color: #10B981;"></div>
    </div>
  </div>
</div>
