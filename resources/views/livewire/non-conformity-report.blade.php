...
<div>
    <a class="absolute top-4 left-4 bg-red-500 text-white font-bold py-2 px-4 rounded hover:bg-red-700 print:hidden" href="{{ url('admin/non-conformity-reports') }}">
        <button>
            Go back
        </button>
    </a>
    <div style="font-family: 'Times New Roman', Times, serif;">
        <div class="relative w-[8.5in] h-[11in] bg-cover bg-no-repeat mx-auto  page-break border">
            ...
            <section class="mx-12 px-12 py-1 flex flex-row justify-between text-[11px]">
                ...
                <div class="flex-1 ml-8">
                    <div class="flex flex-col">
                        ...
                        <span class="font-semibold text-gray-900">&emsp;</span>
                        <span class="font-medium text-gray-900 font-arial">{{ $selections[$selectedReport->isCalibrationCompleted] }}</span>
                        ...
                        <span class="font-medium text-gray-900 font-arial">{{ $selections[$selectedReport->troubleshootingStatus] }}.</span>
                    </div>
                </div>
            ...
            <section class="mx-12 px-8 py-1 flex flex-row justify-between text-[11px] border-[.100rem] border-gray-700 text-justify">
                <div class="font-arial">
                    <div class="flex flex-row">
                        <div class="flex flex-col">
                            <p class="font-semibold text-gray-900 -mx-6 italic text-[14px]" style="font-family: 'Times New Roman', Times, serif">Chargeable Items:</p>
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="pl-14 text-gray-900">{{ is_numeric($selectedReport->conditionalFeeAmount) ? 'PHP ' . $selectedReport->conditionalFeeAmount : $selectedReport->conditionalFeeAmount }}
                            </span>
                        </div>
                        <div class="flex flex-col">
                            <p class="font-semibold text-gray-900 -mx-6">&emsp;</p>
                    ...
                    <div class="flex flex-col text-[8px]">
                        <p><span class="font-semibold">Please Note:</span> Repair price quote will be emailed upon completion of the troubleshooting. Diagnostic fee is WAIVED upon approval of repair.
                            Diagnostic fee will also be WAIVED if no replacement parts are available or if we determine unit is beyond economical repair.
                        </p>
                    </div>
                </div>
            </section>
            <section class="mx-12 px-8 py-2 text-[11px]">
                ...
                <div class="text-[11px] font-arial">
                    ...
                    <div class="flex items-center gap-2">
                        <span class=" w-3 h-3 text-black border-[.100rem] border-gray-900"></span>
                        <span>Highlight test points or parameters in Measurement Report. Describe nonconformity in the Remarks Section.</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <span class=" w-3 h-3 text-black border-[.100rem] border-gray-900"></span>
                        <span>Highlight test points or parameters in Measurement Report, no explanation/description required in the Remarks Section.</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <span class=" w-3 h-3 text-black border-[.100rem] border-gray-900"></span>
                        <span>Do not highlight nonconforming test points or parameters. Describe nonconformity in the Remarks Section.</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <span class=" w-3 h-3 text-black border-[.100rem] border-gray-900"></span>
                        <span>Do not highlight nonconforming test points or parameters, no explanation/description required in the Remarks Section.</span>
                    </div>
                </div>
                <div class="mt-2 -mx-4 text-[12px]">
                    <h1><span class="font-bold">Note:</span> Revision of Printed Measurement Report will incur revision/reprinting fee</h1>
                </div>
            </section>
            <div class="absolute bottom-12">
                <section class="mx-12 px-8 py-2 text-[11px]">
                    <div class="flex w-full justify-around">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-xs font-medium text-black overline">&emsp;&emsp;&emsp;&emsp;&emsp;Signature Over Printed Name&emsp;&emsp;&emsp;&emsp;&emsp;</p>
                        </div>
                        <div class="flex flex-col items-center">
                            <p class="text-xs font-medium text-black">&emsp;</p>
                            <p class="text-xs font-medium text-black overline">&emsp;&emsp;&emsp;&emsp;&emsp;Date&emsp;&emsp;&emsp;&emsp;&emsp;</p>
                        </div>
                    </div>
                ...
                <section class="mx-8 px-8">
                    <div class="text-[9px] font-medium text-black leading-3 text-justify">
                        Client understands that there are inherent risks associated in troubleshooting and/or repair of client's equipment. As a condition of PMSi performing 
                        troubleshooting and/or repair to clients equipment, client agrees to indemnify and hold harmless PMSi and its officers, employees and agents from any and all damages
                        (including partial or total equipment incapacitance), from personal injury or illness, from loss or damage to property, or from costs, including court cost and
                        attorney's fees that may result from or arising from the troubleshooting and/or repair of clients equipment. A client's verbal, email or other written instructions
                        to PMSi (or any personnel) to perform troubleshooting and/or repair is agreed upon by client as sufficient evidence of understanding this terms and agreement.
                    </div>
                </section>
            </div>
            {{-- Footer --}}
