<div>
  ...
  <button wire:loading.attr="disabled" wire:click="downloadFiles"
    class="bg-red-500 text-white font-bold py-2 px-4 rounded hover:bg-red-700 mx-auto absolute top-4 left-4">
      ...
      <div class="relative bg-cover bg-no-repeat mx-auto border border-white page-break">
        ...
        <div class="border-b border-white">
          <table class="w-full text-sm mt-4 text-left text-gray-700 dark:text-gray-400 table-fixed">
            <thead
              class="text-[11px] text-center text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
              <tr>
