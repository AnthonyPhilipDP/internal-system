<div style="font-family: 'Times New Roman', Times, serif;">
  @foreach ($equipmentData as $equipment)
    <div class="relative w-[8.5in] h-[11in] bg-cover bg-no-repeat mx-auto  page-break border">
      ...
      <div class="absolute top-[60px] right-14 bottom-0 w-[150px] h-[99.77px]">
        <img src="{{ asset('images/pabLogo.png') }}" alt="PAB Logo">
      </div>
      <div class="flex flex-col pt-[240px] px-12 space-y-2">
        ...
        @php
          ...
          $inCondition = [
              ...
              'in operative' => 'Inoperative',
              'in-operative' => 'Inoperative',
              'malfunctioning' => 'Malfunctioning',
              'brokenDisplay' => 'Broken Display',
              'broken display' => 'Broken Display',
              'broken-display' => 'Broken Display',
              ...
              'limited cal' => 'Limited Calibration',
              'limited-cal' => 'Limited Calibration',
              'limited calibration' => 'Limited Calibration',
              'limited-calibration' => 'Limited Calibration',
              'overdueCalibration' => 'Overdue Calibration',
              'overdue calibration' => 'Overdue Calibration',
              'overdue-calibration' => 'Overdue Calibration',
          ...
          $outCondition = [
              ...
              'cal before use' => 'Calibrated Before Use',
              'cal-before-use' => 'Calibrated Before Use',
              'conditionalCal' => 'Conditional Calibration',
              'conditional cal' => 'Conditional Calibration',
              'conditional-cal' => 'Conditional Calibration',
              'conditionalCalibration' => 'Conditional Calibration',
              'conditional calibration' => 'Conditional Calibration',
              'conditional-calibration' => 'Conditional Calibration',
              'defective' => 'Defective',
              'disposed' => 'Disposed',
              'ejected' => 'Ejected',
              ...
              'no capability' => 'Rejected - No Capability',
              'no-capability' => 'Rejected - No Capability',
              'returned' => 'Rejected - Returned',
              'disposed' => 'Rejected - Disposed',
              'referToReport' => 'Refer to Report',
              'refer to report' => 'Refer to Report',
              'refer-to-report' => 'Refer to Report',
              'seeRemarks' => 'See Remarks',
              'see remarks' => 'See Remarks',
              'see-remarks' => 'See Remarks',
        ...
        <div class="absolute bottom-[170px] left-16 right-16">
          <p class="text-xs text-gray-800 text-justify pt-2">
            Precision Measurement Specialists, inc. (PMSi) certifies that the instrument specified above was calibrated
            according to PMSi's Management System which is intended to meet PNS ISO/IEC 17025:2017.
            This instrument was calibrated with working standards whose measurement results are traceable to either the
            National Institute of Standards and Technology (NIST, USA), to National Metrology Laboratory of the
            Philippines (NML),
            to other international accredited metrology labs, to NIST accepted intrinsic standards of measurement, to
            fundamental or physical constants, or by comparison to consensus standards.
            Calibration data or report is issued under separate cover that includes specific or applicable traceability.
          </p>
          <p class="text-xs text-gray-800 text-justify pt-2">
            Precision Measurement Specialists, inc. maintains traceability records on all instruments under contract.
            Records are on file, available for inspection by authorized representatives of the contracting
          ...
          <div class="grid grid-cols-1 text-xs uppercase italic font-bold">
            <div class="flex">
              <p class="pl-[140px] text-[8.5px]">May not be published or reproduced except in full without written
                authorization from PMS<span class="lowercase">i</span></p>
            </div>
            <div class="flex">
              <p class="pl-[140px] text-[8.5px]">May not be used to claim endorsement by PMS<span
                  class="lowercase">i</span> and by accrediting or traceability organizations mentioned</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="absolute bottom-[130px] w-full">
        <h1 class="text-center text-xs border border-gray-800 mx-64">Certificate not valid without embossed dry seal.
        </h1>
      </div>
      <div class="absolute bottom-[75px] left-0 w-full flex justify-around px-12">
        <div class="flex w-full justify-around">
          ...
          <div class="flex flex-col items-center">
            <p class="text-sm font-normal text-black">{{ date('d-M-Y', strtotime($equipment['calibrationDate'])) }}
            </p>
