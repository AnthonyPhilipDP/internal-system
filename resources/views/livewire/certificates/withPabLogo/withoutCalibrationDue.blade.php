    ...
    <div class="relative w-[8.5in] h-[11in] bg-cover bg-no-repeat mx-auto  page-break border">
      ...
      <div class="flex flex-col pt-[240px] px-12 space-y-2">
        ...
        <div class="flex flex-col">
          ...
          <div class="flex justify-between">
            <div class="flex w-[50%]">
              <p class="w-[48%] font-semibold uppercase text-sm text-right mr-[20px]">CAL Procedure: </p>
              <p class="text-sm">{{ $equipment['calibrationProcedure'] }}</p>
            </div>
            <div class="flex w-[48%]">
        ...
        <div class="absolute bottom-[170px] left-16 right-16">
          <p class="text-xs text-gray-800 text-justify pt-2">
            ...
            fundamental or physical constants, or by comparison or consensus standards.
