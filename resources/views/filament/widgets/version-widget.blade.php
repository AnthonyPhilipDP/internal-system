<x-filament-widgets::widget class="fi-filament-info-widget">
  <x-filament::section>
    <div class="flex items-center gap-x-3">
      <div class="flex-1">
        <a href="http://localhost:8000/" rel="noopener noreferrer" target="_blank" class="font-bold">
      ...
      <div class="flex flex-col items-end gap-y-1">
        <x-filament::link wire:navigate color="gray" href="/release-notes" icon="heroicon-m-book-open"
          icon-alias="panels::widgets.filament-info.open-documentation-button">
          <span class="text-red-500">{{ __('Release Notes') }}</span>
        </x-filament::link>

        <x-filament::link color="gray" href="" icon="heroicon-m-shield-check">
